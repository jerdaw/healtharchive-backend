...
1) **Create this plan doc**
   - File: `docs/planning/2026-01-17-ops-tiering-alerting-and-incident-followups.md` (this document)
...
3) **Roadmaps index**
   - Update `docs/planning/README.md` to list this plan under "Implementation plans (active)".
...
Add to Prometheus alert rules (typically `/etc/prometheus/rules/healtharchive.yml`):
      ...
      - alert: HealthArchiveTieringStale
        ...
        annotations:
          ...
          runbook_url: "https://github.com/jerdaw/healtharchive-backend/blob/main/docs/operations/playbooks/core/incident-response.md"
...
If canary replay or per-job recovery were deferred, add them to `docs/planning/roadmap.md`
under appropriate sections.

### 5.3 Archive this plan

Move this plan to `docs/planning/implemented/2026-01-17-ops-tiering-alerting-and-incident-followups.md`
when complete.
