...
The roadmap `docs/roadmaps/2026-01-03-search-ranking-and-snippets-v3.md` defined a phased implementation plan to address these gaps while maintaining single-VPS constraints.
...
- Roadmap: `docs/roadmaps/2026-01-03-search-ranking-and-snippets-v3.md`
