...
This is the **historical, step-by-step execution plan** that was used to bring HealthArchive to the current production state across:
...
- Keep `docs/operations/healtharchive-ops-roadmap.md` short; it should reference canonical docs
  and `docs/roadmaps/roadmap.md` rather than duplicating this historical plan.
...
## Phase 8 — Research exports, dataset releases, and Researchers page accuracy
...
4. Implement the Researchers page workflow (avoid “planned” contradictions):
