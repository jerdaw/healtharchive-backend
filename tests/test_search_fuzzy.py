...
def test_pick_word_similarity_threshold_scales_with_token_length() -> None:
    ...
    assert pick_word_similarity_threshold(["coronovirus"]) == 0.28
...
def test_should_use_url_similarity_for_long_or_urlish_tokens() -> None:
    assert should_use_url_similarity("coronovirus") is False
    ...
    assert should_use_url_similarity("https://www.canada.ca/en/") is True
